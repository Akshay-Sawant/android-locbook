...
public class VersovaTrains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_versova_trains);
        ...
        // Recycler View
        metroList = (RecyclerView) findViewById(R.id.versova_timetable_list);
        ...
        while (cursor.moveToNext()) {
            MetroTimeTable metroTimeTable = new MetroTimeTable(cursor.getString(cursor.getColumnIndex(LocBookDatabase.V_TIME)),
                    cursor.getString(cursor.getColumnIndex(LocBookDatabase.V_G)));
