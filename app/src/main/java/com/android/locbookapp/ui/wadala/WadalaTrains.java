...
public class WadalaTrains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()) {
            MonoTimeTable monoTimeTable = new MonoTimeTable(cursor.getString(cursor.getColumnIndex(LocBookDatabase.W_TIME)),
                    cursor.getString(cursor.getColumnIndex(LocBookDatabase.C_W)), cursor.getString(cursor.getColumnIndex(LocBookDatabase.MODE)),
                    cursor.getString(cursor.getColumnIndex(LocBookDatabase.DES_WADALA)));
